    ...
    private static long hashQuad(
        ...
        if (tintIndex != -1) {
            if (hashStorage.lastTintIndex == tintIndex) {
                ...
                // TODO(26.2): BlockColors.getColor was removed; block tint is now resolved through the
                // model/quad pipeline. Stubbed to white so hashing stays deterministic for the build.
                int tintColor = VoxelColor.WHITE;
